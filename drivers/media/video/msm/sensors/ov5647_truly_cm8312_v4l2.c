...
#define OV5647_TRULY_CM8312_VERBOSE_DGB

#ifdef OV5647_TRULY_CM8312_VERBOSE_DGB
...
#define OV5647_TRULY_CM8312_OTP_FEATURE
...
#ifdef OV5647_TRULY_CM8312_OTP_FEATURE
/*******************************************************************************
*
*******************************************************************************/
struct otp_struct {
...
*******************************************************************************/
#define OV5647_TRULY_CM8312_RG_RATIO_TYPICAL_VALUE 86
#define OV5647_TRULY_CM8312_BG_RATIO_TYPICAL_VALUE 88
/*******************************************************************************
* call this function after OV5647_TRULY_CM8312 initialization
* return value:
*     0, update success
*     1, no OTP
*******************************************************************************/
uint16_t ov5647_update_otp(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	/* calculate G_gain */
	/* 0x400 = 1x gain */
	if (st_ov5647_otp.bg_ratio < OV5647_TRULY_CM8312_BG_RATIO_TYPICAL_VALUE) {
		if (st_ov5647_otp.rg_ratio < OV5647_TRULY_CM8312_RG_RATIO_TYPICAL_VALUE) {
			G_gain = 0x400;
			B_gain = 0x400 *
				OV5647_TRULY_CM8312_BG_RATIO_TYPICAL_VALUE /
				st_ov5647_otp.bg_ratio;
			R_gain = 0x400 *
				OV5647_TRULY_CM8312_RG_RATIO_TYPICAL_VALUE /
